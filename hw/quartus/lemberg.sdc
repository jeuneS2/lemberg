...
set_min_delay 0 -from [get_clocks {*ssram_pll:pll*_clk0}] -to [get_ports {sram_pin_out.clk}]
set_max_delay 3 -from [get_clocks {*ssram_pll:pll*_clk0}] -to [get_ports {sram_pin_out.clk}]
