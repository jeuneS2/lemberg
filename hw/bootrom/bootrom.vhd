...
process(a) begin
	case a is
		...
		when X"01" => d <= X"f6460825";
		when X"02" => d <= X"8a07f267";
		when X"03" => d <= X"80898000";
		...
		when X"91" => d <= X"cf005017";
		when X"92" => d <= X"a1f831c0";
